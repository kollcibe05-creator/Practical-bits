 ...
 // console.log(username.name?.movie =="Peaky" ? "Yes": "
 function iterate() {
 ...
 console.log(iterate())
 // console.log(Object.keys(username).len
...
const [identifier, house, things, activity] = oneArr
console.log(name)
const {ident, age:meme} = oneObj
let arr =  [
...
const {name} = arr[0];
const oneObject    = {id: 1, name: "Collo", age: 5}
